 ...
 * @author Y.Chen5
 */
public class CyProgressCircleLayout extends FrameLayout {

    private static final String TAG = CyProgressCircleLayout.class.getName();
    ...
    public CyProgressCircleLayout(@NonNull Context context) {
        this(context, null);
    }

    public CyProgressCircleLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CyProgressCircleLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
