...
public class ToastUtil {
    private static final String TAG = ToastUtil.class.getName();
    private ToastUtil() {
...
//        }
    ...
    public static void showDefaultShortToast(Context context, String msg) {
        Toast.makeText(context, msg, Toast.LENGTH_SHORT).show();
    }
    public static void showDefaultShortToast(Context context, @StringRes int id) {
        Toast.makeText(context, context.getString(id), Toast.LENGTH_SHORT).show();
    }
    public static void showDefaultLongToast(Context context, String msg) {
        Toast.makeText(context, msg, Toast.LENGTH_LONG).show();
    }

    public static void showDefaultLongToast(Context context, @StringRes int id) {
